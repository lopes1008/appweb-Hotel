...
<footer style="background-color: black;">
    ...
    <p class="text-justify">Informations générales à propos de l'application et ces avantages</p><br>
      <center><a href="à propos.php" style="background-color:white;color:black;border-color:black;" class="btn btn-danger"><b>Voir plus</b></a></center><br><br><br>
      <li><a href="admin/admin.php"title="Admin Login"><span class="glyphicon glyphicon-user"></span>Connexion administrateur</a></li>
 <?php
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Email :&nbsp;</strong>contact@hoteletoile.com</p>
      <p style="color:white;"><strong>Contact :&nbsp;</strong>+33 6 43 52 31 93</p><br><br><br>
	</div>&nbsp;

	<div class="col-sm-4 text-center">
      <div class="panel panel-primary">
        <div style="background-color: white; color:black; border-color:black;"  class="panel-heading">Commentaires</div>
