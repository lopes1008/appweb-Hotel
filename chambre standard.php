...
<body style="margin-top:50px;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Prochain</span>
		...
		<h2 class="Ac_Room_Text">Chambre standard</h2>
		<p class="text-justify">Chambres a une conception simple avec lit king et elle est bien équipée avec des équipements modernes.</p>
    <div class="row">
