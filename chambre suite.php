...
<body style="margin-top:50px;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Prochain</span>
		...
		<p class="text-justify">Profitez d'une meilleure vue depuis le coin salon attenant. Version améliorée de la chambre de luxe, ces chambres 
		offrent un design élégant avec un grand espace.</p>
    <div class="row">
