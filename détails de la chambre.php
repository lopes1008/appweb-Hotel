...
?>
    ...
    <div class="row">
      ...
      <a href="identifier.php" class="btn btn-danger">Réserve maintenant</a><br><br>
      </div>
	</div>
				<div class="col-sm-3">
           ...
           while($result1= mysqli_fetch_assoc($sql1))
           {
            ...
            ?>
            <a href="détails de la chambre.php?room_id=<?php echo $result1['room_id']; ?>"><?php echo $result1['type']; ?></a><hr>
            <?php } ?>    					
					</div>
				</div>
				</div>
