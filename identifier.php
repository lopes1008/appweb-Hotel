...
{
header('location:formulaire de réservation.php');
}
error_reporting(1);
...
if(isset($login))
{
  if($eid=="" || $pass=="")
  {
  $error= "<h4 style='color:red'>Remplissez tous les champs</h4>";  
  }   
  else
  {
  $sql=mysqli_query($con,"select * from create_account where email='$eid' && password='$pass' ");
    ...
    {
    $error= "<h4 style='color:red'>Informations de connexion invalide</h4>"; 
    } 
  }
}
?>
      ...
      <div class="col-sm-4"></div>
        <div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:#f4ac41;"><br>
          ...
          <div class="form-group forget">
                <a href="compte oublié.php">Compte oublié</a>&nbsp; <b>|</b>&nbsp; 
                <a href="formulaire d'inscription.php">Créer un compte</a>
            </div>
      	</form><br>
        </div>
    </div><br>
