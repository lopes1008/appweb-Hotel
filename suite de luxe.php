...
<body style="margin-top:50px;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Prochain</span>
		...
		<h2 class="Ac_Room_Text">Suite de luxe</h2>
		<p class="text-justify">Plongez-vous dans le luxe luxueux de nos chambres haut de gamme. Version améliorée de la chambre Suite, ces chambres
		offrent un design élégant avec un espace plus grand</p>
    <div class="row">
